...
use Akbardwi\LaravelEnvEditor\Contracts\FormatterInterface;
use Akbardwi\LaravelEnvEditor\Contracts\WriterInterface;
use Akbardwi\LaravelEnvEditor\Exceptions\UnableWriteToFileException;
...
class DotenvWriter implements WriterInterface
{
     ...
     *
     * @var \Akbardwi\LaravelEnvEditor\Workers\Formatters\Formatter
     */
    protected $formatter;
