...
use Akbardwi\LaravelEnvEditor\Contracts\ParserInterface;
use Akbardwi\LaravelEnvEditor\Contracts\ReaderInterface;
use Akbardwi\LaravelEnvEditor\Exceptions\UnableReadFileException;
...
class DotenvReader implements ReaderInterface
{
     ...
     *
     * @var \Akbardwi\LaravelEnvEditor\Workers\Parsers\Parser
     */
    protected $parser;
